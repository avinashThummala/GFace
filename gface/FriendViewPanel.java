...
public class FriendViewPanel extends javax.swing.JPanel {

    FriendViewPanel(ChatFriendEntry friend, FBChat ref, ChatUserEntry user) {
    ...
    private class DoubleClickListener extends MouseAdapter
    {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            {
                //Open a chat with this friend
                
                //Has a chat window already been created. Use it. Otherwise create a new one.
                
                if(ref.chatWindows.containsKey(ref.getPosJabberId(cFriendEntry.rEntry.getUser())) )
                {
                    CMessageFrame cMFrame=(CMessageFrame)ref.chatWindows.get(ref.getPosJabberId(cFriendEntry.rEntry.getUser()));
                ...
                {
                    CMessageFrame cMFrame=new CMessageFrame(cFriendEntry, uEntry, ref);
                    cMFrame.setLocationRelativeTo(ref.cFrame);                    
                    cMFrame.repaint();
                    cMFrame.setVisible(true);
